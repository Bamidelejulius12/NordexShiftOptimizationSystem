...
def load_data():
    """"
        load data from a database file, and return a pandas dataframe for 
        other pipeline to be able to male use of it.
    """
    try:
        logging.info("data ingestion inititated....")
        logging.info("loading data from the database file....")
        # initating the connection to the database file.
