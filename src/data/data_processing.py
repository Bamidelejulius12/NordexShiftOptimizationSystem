...
class DataProcessor:
    ...
    def filling_missing_values(self):
        try:
            logging.info("filling missing value started...")
            ...
            self.data["resolved_by"] = self.data["resolved_by"].fillna("No Maintenace")
            ...
            logging.info("filling missing value completed successfully...")
    ...
    def split_X_y(self, data: pd.DataFrame):
        try:
            ...
            logging.info(X.head())
            logging.info(y.head())
            logging.info("data has been succcessfully splitted into features and target columns...")
            return X, y 
        except Exception as e:
            logging.error("error occured while splitting into features and target columns")
            raise MyException(e, sys)
